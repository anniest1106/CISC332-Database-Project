...
<body>
    ...
    while($row = mysql_fetch_array( $query )) {
        ...
        echo "<tr><td>$CommentID</td> 
                  <td>$Topic</td>
                  <td>$Comment</td>";
        echo '<td><a href="replyComment.php?id='.$CommentID.'">Reply</a></td>'; 
        echo "</tr>"; 
        } 
    ...
    <center><button type="button" class="backToProfile" onClick="parent.location='allreply.php'" style="float: center">All comments</button></center><br>
